...
uglifyjs js/prototypes.js js/model.js js/storage.js js/audio_controller.js js/alert.js js/information.js js/setup_controls.js js/main.js js/keyboard_shortcuts.js js/window_resize.js js/install.js service_worker.js -o js/bundle.js
