...
if ('serviceWorker' in navigator) {
  	...
  	navigator.serviceWorker.register('/just-intonation/service_worker.js', { scope: '/just-intonation/' }).then(function(reg) {

	    if(reg.installing) {
	      console.log('just-intonation: Service worker installing');
	    } else if(reg.waiting) {
	      console.log('just-intonation: Service worker installed');
	    } else if(reg.active) {
	      console.log('just-intonation: Service worker active');
	    }
